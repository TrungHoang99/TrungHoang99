<footer class="footer has-cards">
    <div class="container">
        <div class="row row-grid align-items-center my-md">
            ...
            <h4 class="mb-0 font-weight-light">Let's create a lot of valuable Comic articles.</h4>
            </div>
        ...
        <div class="row align-items-center justify-content-md-between">
            <div class="col-md-6">
            <div class="copyright">
                &copy; 2020 <a href="" target="_blank">BlogComic</a>.
            </div>
            </div>
            <div class="col-md-6">
            <ul class="nav nav-footer justify-content-end">
                <!-- <li class="nav-item">
                <a href="" class="nav-link" target="_blank">Chun Chun</a>
                </li> -->
                <li class="nav-item">
